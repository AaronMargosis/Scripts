<#
.SYNOPSIS
Download the latest Sysinternals tools to "C:\Program Files\Sysinternals" and ensure that directory is in the Path.
...
$fLocal = $env:TEMP + '\SysinternalsSuite.zip'
$targDir = 'C:\Program Files\Sysinternals'
