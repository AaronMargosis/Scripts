<#
.SYNOPSIS
Download the latest SysNocturnals tools to "C:\Program Files\SysNocturnals" and ensure that directory is in the Path.
...
$url = "https://github.com/AaronMargosis/Aaron-Margosis-SysNocturnals-Tools/releases/latest/download/SysNocturnalsSuite.zip"
$fLocal = $env:TEMP + '\SysNocturnalsSuite.zip'
$targDir = 'C:\Program Files\SysNocturnals'
